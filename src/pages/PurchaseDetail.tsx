                  ...
                  <div className="group hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 p-4 rounded-xl transition-all duration-200">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-lg text-gray-900">{po?.receivedBy}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {po?.items.map((item, index) => (
                  <tr key={item._id} className={`hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-purple-50/50 transition-all duration-300 border-b border-gray-100 ${item?.isCancelled ? 'bg-red-100' : item?.isReturn ? 'bg-yellow-100' : ''} `}>
                    <td className="px-8 py-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          {
                            item?.isReturn && (
                              <span className='text-yellow-500 font-bold'>({item?.isReturn ? "Item Returned" : ''})</span>
                            )
                          }
                        </div>
                      </div>
                    ...
                    <td className="px-8 py-6 text-right">
                      <span className={`font-bold text-2xl ${item?.isCancelled ? 'text-red-500 line-through' : item?.isReturn ? 'text-yellow-500 line-through' : 'text-emerald-500'}`}>
